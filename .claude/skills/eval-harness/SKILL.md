---
name: eval-harness
description: Formal evaluation framework for Claude Code sessions implementing eval-driven development (EDD) principles. Define tests before implementation, measure agent reliability with pass@k metrics.
origin: ECC
version: 1.8
---
